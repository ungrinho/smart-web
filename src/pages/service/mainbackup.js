      ...
      <Content>
        ...
        {isSmallScreen ? (
          ...
          <>
            <MobileCard>
              <CardContent>
                <CardTitle variant="h6">현재 온습도</CardTitle>
                <CardText>온도: {sensorData.temperature}°C</CardText>
                <CardText>습도: {sensorData.humidity}%</CardText>
              </CardContent>
            </MobileCard>
            <MobileCard>
              <CardActionArea onClick={handleOpenModal}>
                <CardContent>
                  <CardTitle variant="h6">전날 평균 온습도</CardTitle>
                  <YesterdayData />
                </CardContent>
              </CardActionArea>
            </MobileCard>
            <MobileCard>
              <CardContent>
                <CardTitle variant="h6">Robot Condition</CardTitle>
                <CardText>상태: {robotStatus}</CardText>
                <CardText>배터리: {robotBattery}</CardText>
              </CardContent>
            </MobileCard>
            <MobileCard>
              <CardActionArea component={Link} to="/manage">
                <CardContent>
                  <CardTitle variant="h6">관리 페이지</CardTitle>
                  <CardText>이동하기</CardText>
                </CardContent>
              </CardActionArea>
            </MobileCard>
            <MobileCard>
              <CardActionArea component={Link} to="/obj">
                <CardContent>
                  <CardTitle variant="h6">객체 확인 페이지</CardTitle>
                  <CardText>이동하기</CardText>
                </CardContent>
              </CardActionArea>
            </MobileCard>
            <MobileCard>
              <CardActionArea component={Link} to="/cs">
                <CardContent>
                  <CardTitle variant="h6">CS 페이지</CardTitle>
                  <CardText>이동하기</CardText>
                </CardContent>
              </CardActionArea>
            </MobileCard>
